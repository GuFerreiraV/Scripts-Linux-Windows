...
## Explicando customize_waybar

- Script para personalizar a barra waybar.
- O script cria um backup dos arquivos originais antes de modificar.
- O script modifica os arquivos originais.
- Obs: O script está configurado para placas amd e nvidia.
- Dependências: jq, firecode nerd font, waybar:
  - `sudo pacman -S ttf-fira-code-nerd ttf-font-awesome`
  - `sudo pacman -S jq`
